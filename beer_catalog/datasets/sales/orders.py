...
from hela.data_types import String, Double
...
orders = PandasParquetDataset(
    ...
    columns=[
        ...
        Col('order_status', String(),
            'The status of the order, e.g. cancelled or completed.'),
        Col('price', Double(),
            'How much money the order is worth or customer has to pay.'),
        Col('currency', String(),
            'Three letter combination describing currency e.g. EUR.'),
        Col('test_col', String(),
